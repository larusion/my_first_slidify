...
g <- ggplot(olympic.track.1896.1964, aes(olympic.track.1896.1964[, 1], olympic.track.1896.1964[, 2]))
                
g + geom_point() + labs(title = "Olympic Track Times") + 
                        labs(x = "YEAR", y = paste("Winning Time in the", strsplit(colnames(olympic.track.1896.1964)[2], "\\.")[[1]][2]))
